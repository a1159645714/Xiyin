...
1. Main product image: show the complete product clearly while a natural female hand with a realistic everyday manicure holds or gently presents it. The nails should be natural-looking, medium length, softly almond-shaped or oval-shaped, with nude, translucent, pale pink, or low-saturation creamy glossy polish. Keep the product dominant, with a clean background and no text.
...
4. Detail / material close-up image: show the product held by a female hand with a realistic everyday manicure: medium-length softly almond-shaped or oval-shaped nails with nude, translucent, pale pink, or low-saturation creamy glossy polish. The fingers should naturally reveal texture, surface, structure, color, finish, edges, or craftsmanship without changing the product.
5. Hand interaction image: show a close realistic view of female hands with the same natural everyday manicure holding, operating, pressing, arranging, assembling, or interacting with the product. Keep all fingers anatomically correct and the product unobstructed.
...
Human hand redrawing requirements: if hands are included, the hands may be fully redrawn or replaced while keeping the target product unchanged. For female hands, use a realistic everyday manicure similar to a clean nude or pale-pink glossy manicure: natural skin tone, medium-length softly almond-shaped or oval-shaped nails, and restrained low-saturation colors. Do not use exaggerated long stiletto nails, neon colors, rainbow colors, heavy decorations, or complex nail art. The new hands must look natural and realistic, with correct anatomy, the correct number of fingers, reasonable grip, and believable contact with the product. Hands must not cover key selling points, logos, text, labels, or the core structure of the target product.
...
At least 6 of the 9 panels must show natural hands actively holding, squeezing, arranging, playing with, or interacting with the product. Include at least 2 panels with realistic female hands that clearly show a natural everyday manicure: medium-length softly almond-shaped or oval-shaped nails with nude, translucent, pale pink, or low-saturation creamy glossy polish. Do not use exaggerated long colorful nails. Also include at least 2 panels with child hands or parent-child hand interaction. Use no more than 1 pure product-only background display panel.
Do not use unrelated props such as rulers, coins, phones, cups, or keys as scale references. If complete dimensions are supplied, one panel may show a clean product dimension diagram using only those dimensions and the requested unit. Even without a dimension diagram, keep the product's apparent size realistic relative to hands and everyday surfaces so it does not look tiny in the frame.
