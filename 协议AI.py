...
1. Main product image: clean plain background, full product clearly visible, centered or balanced composition, minimal distractions, no text.
2. Included-items image: show what the buyer receives only if those items are already visible in the uploaded image or clearly part of the target product. Do not add packaging, boxes, bags, labels, tags, manuals, instruction sheets, barcode stickers, warning labels, certification marks, or fake accessories.
3. Core play / usage image: show the toy being used, played with, handled, assembled, displayed, or interacted with in a natural and realistic way based on the product's actual design.
4. Detail / material close-up image: highlight real visible details such as texture, surface, structure, color, finish, edges, or craftsmanship without changing the product.
5. Hand interaction image: show realistic hands holding, operating, arranging, assembling, or interacting with the product. Hands may be fully redrawn or replaced while keeping the product unchanged.
6. Lifestyle scene image: show the product in a clean realistic everyday environment, such as a tabletop, children's room, living room, gift scene, storage scene, or simple toy-use setting, depending on the uploaded toy type.
7. Quality-feeling image: visually communicate a clean, durable, friendly, smooth, well-made, or child-friendly feeling through realistic photography, without adding unsupported certification text, safety claims, warning signs, icons, labels, badges, or fake marks.
8. Gift / emotional value image: show the product in a natural gifting, family, parent-child, friend interaction, holiday, birthday, collection, display, or pleasant play atmosphere, depending on the uploaded toy type. Keep the scene plain, realistic, and not overly decorative. Do not add gift boxes, gift bags, packaging, ribbons, labels, or text unless they are already visible in the uploaded image.
9. Advertising whitespace / secondary hero image: create a clean premium commercial composition with the product clearly visible and enough blank space for later text placement. Do not generate any text, icons, labels, badges, warnings, or marks inside the image.

Size-reference restriction: do not create explicit size-comparison images. Do not use eggs, coins, rulers, measuring tapes, hands, palms, fingers, credit cards, phones, cups, bottles, keys, pens, notebooks, fruit, or any other object mainly intended to show the product's size. Props may appear only if they are natural to the scene and not used as a direct size reference. Do not add measurement marks, arrows, scale lines, size labels, or comparison text.
