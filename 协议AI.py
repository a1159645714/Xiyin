...
1. Main product image: show the complete product clearly while a natural female hand with visible manicured nails and polished nail art holds or gently presents it. Keep the product dominant, with a clean background and no text.
...
4. Detail / material close-up image: show the product held by a female hand with visible manicure and polished nails, with the fingers naturally revealing texture, surface, structure, color, finish, edges, or craftsmanship without changing the product.
5. Hand interaction image: show a close realistic view of female hands with visible manicure and polished nails holding, operating, pressing, arranging, assembling, or interacting with the product. Keep all fingers anatomically correct and the product unobstructed.
